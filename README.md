...
- When both the Responses and chat retries fail, the wizard surfaces a bilingual toast (“The AI is currently unavailable, please try again later. / Die KI ist derzeit nicht erreichbar, bitte später erneut versuchen.”) instead of leaking stack traces.
...
- Scheitern sowohl Responses als auch Chat-Retries, blendet der Wizard einen zweisprachigen Hinweis („The AI is currently unavailable, please try again later. / Die KI ist derzeit nicht erreichbar, bitte später erneut versuchen.“) ein, statt Stacktraces zu zeigen.
