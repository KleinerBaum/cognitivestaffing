...
class ProfilePaths(StrEnum):
    ...
    INTAKE_RAW_INPUT = "intake.raw_input"
    INTAKE_SOURCE_LANGUAGE = "intake.source_language"
    INTAKE_TARGET_LOCALE = "intake.target_locale"
    ...
    SELECTION_PROCESS_STEPS = "selection.process_steps"
    SELECTION_STAKEHOLDERS = "selection.stakeholders"
    WORK_LOCATION = "work.location"
    WORK_RESPONSIBILITIES = "work.responsibilities"
    WORK_WORK_POLICY = "work.work_policy"
    CONSTRAINTS_SALARY_MAX = "constraints.salary_max"
    CONSTRAINTS_SALARY_MIN = "constraints.salary_min"
    CONSTRAINTS_TIMELINE = "constraints.timeline"
