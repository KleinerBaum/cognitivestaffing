...
- **2025-02-18:** Dropped the `wizard.flow` (formerly named runner) and `wizard.layout` overrides by introducing typed navigation enums and delegating button rendering to `wizard.layout.render_navigation_controls()`.
