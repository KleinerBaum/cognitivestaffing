...
_FACTOR_LABELS: dict[str, tuple[str, str]] = {
    ...
    "must_have_requirements": ("Pflicht-Skills", "Required skills"),
    "nice_to_have_requirements": ("Optionale Skills", "Optional skills"),
...
_FALLBACK_ADJUSTMENT_RULES: dict[str, dict[str, Any]] = {
    ...
    "must_have_requirements": {
        ...
        "label_de": "Pflicht-Skills",
        "label_en": "Required skills",
        "per_item": 0.015,
        "max": 0.12,
        "offset": 0,
        "description_de": "+1,5 % je Pflicht-Skill (max. +12 %)",
        "description_en": "+1.5% per required skill (max. +12%)",
    },
    "nice_to_have_requirements": {
        "attribute": "nice_to_have_requirements",
        "label_de": "Optionale Skills",
        "label_en": "Optional skills",
        "per_item": 0.0075,
        "max": 0.03,
        "offset": 0,
        "description_de": "+0,75 % je optionalem Skill (max. +3 %)",
        "description_en": "+0.75% per optional skill (max. +3%)",
    },
