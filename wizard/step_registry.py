...
COMPANY_SUMMARY_FIELDS: Final[tuple[str, ...]] = (
    ...
    str(ProfilePaths.COMPANY_INDUSTRY),
    str(ProfilePaths.COMPANY_SIZE),
    str(ProfilePaths.COMPANY_HQ_LOCATION),
    str(ProfilePaths.COMPANY_WEBSITE),
    str(ProfilePaths.COMPANY_MISSION),
    str(ProfilePaths.COMPANY_CULTURE),
...
WIZARD_STEPS: Final[tuple[StepDefinition, ...]] = (  # GREP:STEP_REGISTRY_V2
    ...
    StepDefinition(
        ...
        required_fields=(str(ProfilePaths.BUSINESS_CONTEXT_DOMAIN),),
    ...
    StepDefinition(
        ...
        required_fields=(str(ProfilePaths.DEPARTMENT_NAME),),
        summary_fields=(
            str(ProfilePaths.DEPARTMENT_NAME),
            str(ProfilePaths.TEAM_NAME),
            str(ProfilePaths.TEAM_MISSION),
            str(ProfilePaths.TEAM_REPORTING_LINE),
            str(ProfilePaths.TEAM_HEADCOUNT_CURRENT),
            str(ProfilePaths.TEAM_HEADCOUNT_TARGET),
            str(ProfilePaths.TEAM_COLLABORATION_TOOLS),
            str(ProfilePaths.TEAM_LOCATIONS),
            str(ProfilePaths.POSITION_CUSTOMER_CONTACT_REQUIRED),
            str(ProfilePaths.POSITION_CUSTOMER_CONTACT_DETAILS),
        ),
        allow_skip=False,
    ...
    StepDefinition(
        ...
        required_fields=(str(ProfilePaths.RESPONSIBILITIES_ITEMS),),
        summary_fields=(str(ProfilePaths.RESPONSIBILITIES_ITEMS),),
        allow_skip=False,
    ...
    StepDefinition(
        ...
        summary_fields=(
            ...
            str(ProfilePaths.COMPENSATION_CURRENCY),
            str(ProfilePaths.COMPENSATION_PERIOD),
            str(ProfilePaths.COMPENSATION_VARIABLE_PAY),
            str(ProfilePaths.COMPENSATION_BONUS_PERCENTAGE),
            str(ProfilePaths.COMPENSATION_COMMISSION_STRUCTURE),
    ...
    StepDefinition(
        ...
        required_fields=(),
        summary_fields=(
            str(ProfilePaths.PROCESS_PHASES),
            str(ProfilePaths.PROCESS_STAKEHOLDERS),
            str(ProfilePaths.PROCESS_RECRUITMENT_TIMELINE),
            str(ProfilePaths.PROCESS_HIRING_PROCESS),
            str(ProfilePaths.PROCESS_PROCESS_NOTES),
            str(ProfilePaths.PROCESS_APPLICATION_INSTRUCTIONS),
            str(ProfilePaths.PROCESS_ONBOARDING_PROCESS),
        ),
        allow_skip=True,
