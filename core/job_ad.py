...
JOB_AD_GROUP_LABELS = {
    ...
    "team": ("Team & Struktur", "Team & Structure"),
    "role": ("Rolle & Aufgaben", "Role & Tasks"),
    "skills": ("Skills & Anforderungen", "Skills & Requirements"),
    "employment": ("Beschäftigung", "Employment"),
    "compensation": ("Vergütung & Benefits", "Compensation & Benefits"),
    "process": ("Interview-Prozess", "Interview Process"),
}
